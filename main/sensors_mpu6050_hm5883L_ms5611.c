...
// #include "ak8963.h"
//#include "zranger.h"
#include "vl53l1/zranger2.h"
#include "vl53l1/vl53l1x.h"
//!#include "flowdeck_v1v2.h" //used for x/y drift compensation
...
void sensorsMpu6050Hmc5883lMs5611Init(void)
{
    ...
    DEBUG_PRINTI("sensorsBiasObjInit fin");
    sensorsDeviceInit();
    DEBUG_PRINTI("sensorsDeviceInit fin");
    sensorsInterruptInit();
    DEBUG_PRINTI("sensorsInterruptInit fin");
    sensorsTaskInit();
    DEBUG_PRINTI("sensorsTaskInit fin");
    isInit = true;
}
...
bool sensorsMpu6050Hmc5883lMs5611Test(void)
{
    ...
    //DEBUG_PRINTI("sensorsMpu6050Hmc5883lMs5611Test");
