...
#include "dspLib/xtensa_common_tables.h"
...
* tables are provided and defined in <code>xtensa_const_structs.h</code>.  Include
* this header in your function and then pass one of the constant structures as
* an argument to xtensa_cfft_f32.  For example:
* \par
* <code>xtensa_cfft_f32(xtensa_cfft_sR_f32_len64, pSrc, 1, 1)</code>
* \par
...
* \par
* An example of initialization of the constants for the xtensa_cfft_f32 function follows:
* \code
* const static xtensa_cfft_instance_f32 *S;
* ...
*   switch (length) {
*     case 16:
*       S = &xtensa_cfft_sR_f32_len16;
*       break;
*     case 32:
*       S = &xtensa_cfft_sR_f32_len32;
*       break;
*     case 64:
*       S = &xtensa_cfft_sR_f32_len64;
*       break;
*     case 128:
*       S = &xtensa_cfft_sR_f32_len128;
*       break;
*     case 256:
*       S = &xtensa_cfft_sR_f32_len256;
*       break;
*     case 512:
*       S = &xtensa_cfft_sR_f32_len512;
*       break;
*     case 1024:
*       S = &xtensa_cfft_sR_f32_len1024;
*       break;
*     case 2048:
*       S = &xtensa_cfft_sR_f32_len2048;
*       break;
*     case 4096:
*       S = &xtensa_cfft_sR_f32_len4096;
*       break;
*   }
* \endcode
* \par Q15 and Q31
...
* tables are provided and defined in <code>xtensa_const_structs.h</code>.  Include
* this header in your function and then pass one of the constant structures as
* an argument to xtensa_cfft_q31.  For example:
* \par
* <code>xtensa_cfft_q31(xtensa_cfft_sR_q31_len64, pSrc, 1, 1)</code>
* \par
* computes a 64-point inverse complex FFT including bit reversal.
* The data structures are treated as constant data and not modified during the
* calculation.  The same data structure can be reused for multiple transforms
...
* than the new functions.
* \par
* An example of initialization of the constants for the xtensa_cfft_q31 function follows:
* \code
* const static xtensa_cfft_instance_q31 *S;
* ...
*   switch (length) {
*     case 16:
*       S = &xtensa_cfft_sR_q31_len16;
*       break;
*     case 32:
*       S = &xtensa_cfft_sR_q31_len32;
*       break;
*     case 64:
*       S = &xtensa_cfft_sR_q31_len64;
*       break;
*     case 128:
*       S = &xtensa_cfft_sR_q31_len128;
*       break;
*     case 256:
*       S = &xtensa_cfft_sR_q31_len256;
*       break;
*     case 512:
*       S = &xtensa_cfft_sR_q31_len512;
*       break;
*     case 1024:
*       S = &xtensa_cfft_sR_q31_len1024;
*       break;
*     case 2048:
*       S = &xtensa_cfft_sR_q31_len2048;
*       break;
*     case 4096:
*       S = &xtensa_cfft_sR_q31_len4096;
*       break;
*   }
* \endcode
*
