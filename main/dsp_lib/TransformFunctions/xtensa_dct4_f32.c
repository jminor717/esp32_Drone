 ...
 * - Initializes Real FFT as its process function is used internally in DCT4, by calling xtensa_rfft_init_f32().
 * \par
 ...
 * <pre>
 *xtensa_dct4_instance_f32 S = {N, Nby2, normalize, pTwiddle, pCosFactor, pRfft, pCfft};
 *xtensa_dct4_instance_q31 S = {N, Nby2, normalize, pTwiddle, pCosFactor, pRfft, pCfft};
 *xtensa_dct4_instance_q15 S = {N, Nby2, normalize, pTwiddle, pCosFactor, pRfft, pCfft};
 * </pre>
 ...
 * The CFFT and RFFT structures also needs to be initialized, refer to xtensa_cfft_radix4_f32()
 * and xtensa_rfft_f32() respectively for details regarding static initialization.
 *
