 ...
 * \par Floating-point
 * The main functions are xtensa_rfft_fast_f32() and xtensa_rfft_fast_init_f32().
 * The older functions xtensa_rfft_f32() and xtensa_rfft_init_f32() have been
 ...
 * the first hxtensaonic and so on.
 * \par
 ...
 * <pre>
 *xtensa_rfft_instance_q31 S = {fftLenReal, fftLenBy2, ifftFlagR, bitReverseFlagR, twidCoefRModifier, pTwiddleAReal, pTwiddleBReal, pCfft};
 *xtensa_rfft_instance_q15 S = {fftLenReal, fftLenBy2, ifftFlagR, bitReverseFlagR, twidCoefRModifier, pTwiddleAReal, pTwiddleBReal, pCfft};
 * </pre>
 ...
 * must also be initialized.  Refer to xtensa_cfft_radix4_f32() for details regarding
...
* @param[in]  *S              points to an xtensa_rfft_fast_instance_f32 structure.
