 ...
 * Title:        xtensa_fir_interpolate_f32.c
 ...
 * <pre>
 * xtensa_fir_interpolate_instance_f32 S = {L, phaseLength, pCoeffs, pState};
 * xtensa_fir_interpolate_instance_q31 S = {L, phaseLength, pCoeffs, pState};
 * xtensa_fir_interpolate_instance_q15 S = {L, phaseLength, pCoeffs, pState};
 * </pre>
