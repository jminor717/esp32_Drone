 ...
 * Title:        xtensa_fir_decimate_f32.c
 ...
 * <pre>
 *xtensa_fir_decimate_instance_f32 S = {M, numTaps, pCoeffs, pState};
 *xtensa_fir_decimate_instance_q31 S = {M, numTaps, pCoeffs, pState};
 *xtensa_fir_decimate_instance_q15 S = {M, numTaps, pCoeffs, pState};
 * </pre>
