 ...
 * <pre>
 *    xtensa_lms_instance_f32 S = {numTaps, pState, pCoeffs, mu};
 *    xtensa_lms_instance_q31 S = {numTaps, pState, pCoeffs, mu, postShift};
 *    xtensa_lms_instance_q15 S = {numTaps, pState, pCoeffs, mu, postShift};
 * </pre>
