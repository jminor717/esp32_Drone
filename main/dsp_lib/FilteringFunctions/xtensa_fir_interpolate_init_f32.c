 ...
 * Title:        xtensa_fir_interpolate_init_f32.c
 ...
 * @return        The function returns XTENSA_MATH_SUCCESS if initialization was successful or XTENSA_MATH_LENGTH_ERROR if
 ...
 * where <code>blockSize</code> is the number of input samples processed by each call to <code>xtensa_fir_interpolate_f32()</code>.
 */
