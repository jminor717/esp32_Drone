 ...
 * Title:        xtensa_mat_inverse_f32.c
 ...
 * <code>XTENSA_MATH_SINGULAR</code>.
 ...
 * <code>XTENSA_MATH_SIZE_MISMATCH</code> if the input matrix is not square or if the size
 ...
 * <code>XTENSA_MATH_SINGULAR</code>.  Otherwise, the function returns <code>XTENSA_MATH_SUCCESS</code>.
 */
  ...
  xtensa_matrix_instance_f32 * pDst)
{
  ...
  xtensa_status status;                             /* status of matrix inverse */
