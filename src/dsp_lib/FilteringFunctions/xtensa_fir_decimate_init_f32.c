 ...
 * Title:        xtensa_fir_decimate_init_f32.c
 ...
 * <code>pState</code> is of length <code>numTaps+blockSize-1</code> words where <code>blockSize</code> is the number of input samples passed to <code>xtensa_fir_decimate_f32()</code>.
