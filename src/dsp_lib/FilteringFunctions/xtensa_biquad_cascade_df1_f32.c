 ...
 * <pre>
 *     xtensa_biquad_casd_df1_inst_f32 S1 = {numStages, pState, pCoeffs};
 *     xtensa_biquad_casd_df1_inst_q15 S2 = {numStages, pState, pCoeffs, postShift};
 *     xtensa_biquad_casd_df1_inst_q31 S3 = {numStages, pState, pCoeffs, postShift};
 * </pre>
